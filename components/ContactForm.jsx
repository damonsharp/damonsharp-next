		...
		<>
			...
			<form className="" onSubmit={handleContactForm}>
				<div className="">
					...
					<input
						className="p-3 mt-1 mb-3 w-full rounded"
						type="text"
						id="fname"
						value={data?.fname ?? ""}
				...
				<div className="form-control">
					...
					<input
						className="p-3 mt-1 w-full rounded"
						type="email"
						id="email"
						value={data?.email ?? ""}
				...
				<div className="form-control">
					...
					<textarea
						className="p-3 mt-1 rounded w-full h-48 border-2 border-neutral"
						id="message"
						value={data?.message ?? ""}
				...
				<button className="bg-accent px-5 py-3 text-white rounded mt-5">Send</button>
			</form>
		</>
