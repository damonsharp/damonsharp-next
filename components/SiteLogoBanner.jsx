	...
	return (
		<div
			className="grid grid-cols-4 grid-rows-2 gap-x-3 gap-y-0 items-center text-center justify-around sm:grid-cols-none sm:grid-rows-1 sm:justify-center sm:items-center text-2xl font-bold pt-1 max-w-max m-auto">
					<span
						className="text-accent col-start-2 col-end-4 row-span-1 row-start-1 row-end-2 text-shadow-[0px_0px_4px_var(--color-primary)] sm:col-start-1 sm:col-end-2 sm:row-start-1 sm:row-end-1">
						Damon Sharp
					</span>
			<SiteLogo
			...
			<span
				className="text-accent col-start-2 col-end-4 row-span-1 row-start-2 row-end-3 text-shadow-[0px_0px_4px_var(--color-primary)] text-lg text-center sm:col-start-3 sm:col-end-4 sm:row-start-1 sm:row-end-1 sm:text-2xl sm:text-left">
				Web Engineer
			</span>
